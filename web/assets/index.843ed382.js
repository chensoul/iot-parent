import { _ as _export_sfc, u as useRouter, s as storeToRefs, a as useMenus, b as useRoute, c as useApp, d as defineStore, g as getItem, e as setItem, f as useErrorlog, h as useTags$1 } from './index.4cfe0fe4.js';
import { k as defineComponent, l as openBlock, J as createElementBlock, K as createBaseVNode, $ as pushScopeId, a0 as popScopeId, c as computed, m as createBlock, a1 as resolveDynamicComponent, L as createCommentVNode, S as toDisplayString, F as Fragment, p as resolveComponent, n as withCtx, j as createVNode, Q as renderList, a2 as normalizeClass, r as ref, d as onBeforeMount, w as watch, a as getCurrentInstance, R as createTextVNode, q as reactive, a3 as withKeys, t as nextTick, o as onMounted, a4 as onBeforeUnmount, C as toRefs, a5 as withModifiers, N as withDirectives, a6 as vShow, O as normalizeStyle, a7 as KeepAlive } from './element-plus.aa5fe574.js';
import { A as Avatar, u as useUserinfo } from './index.dc5007b3.js';
import { C as ChangeLang } from './ChangeLang.76b7582f.js';
...
const _withScopeId$2 = n => (pushScopeId("data-v-2c9d04e0"),n=n(),popScopeId(),n);
const _hoisted_1$5 = { class: "brand" };
const _hoisted_2$4 = /*#__PURE__*/ _withScopeId$2(() => /*#__PURE__*/createBaseVNode("div", { class: "title" }, "智能物联控制中台", -1));
...
var Logo = /*#__PURE__*/_export_sfc(_sfc_main$d, [['render',_sfc_render$d],['__scopeId',"data-v-2c9d04e0"]]);
...
const _sfc_main$a = defineComponent({
  ...
  setup() {
    ...
    const activePath = computed(() => {
      if (route.path.startsWith('/productShow/')) {
        return '/productInfo';
      }
      if (route.path.startsWith('/deviceShow/')) {
        return '/deviceInfo';
      }
      return route.path; // 默认为当前路由路径
    });
...
var Menus = /*#__PURE__*/_export_sfc(_sfc_main$a, [['render',_sfc_render$a],['__scopeId',"data-v-658719d4"]]);
...
const _withScopeId$1 = n => (pushScopeId("data-v-0180529a"),n=n(),popScopeId(),n);
...
var Userinfo = /*#__PURE__*/_export_sfc(_sfc_main$5, [['render',_sfc_render$5],['__scopeId',"data-v-0180529a"]]);
