import { _ as _export_sfc, i as useLang, G as GetValidateCode, L as Login, c as useApp, u as useRouter, b as useRoute } from './index.4cfe0fe4.js';
import { C as ChangeLang } from './ChangeLang.76b7582f.js';
import { k as defineComponent, o as onMounted, w as watch, q as reactive, c as computed, r as ref, C as toRefs, J as createElementBlock, K as createBaseVNode, j as createVNode, n as withCtx, F as Fragment, a as getCurrentInstance, p as resolveComponent, l as openBlock, R as createTextVNode, S as toDisplayString, $ as pushScopeId, a0 as popScopeId } from './element-plus.aa5fe574.js';
...
const _sfc_main = defineComponent({
  ...
  name: 'login',
  setup() {
    // 添加onMounted钩子函数，用于请求后端地址获取验证码图片
    onMounted(() => {
      state.generateValidateCode();
    });
    ...
    const state = reactive({
      ...
      submit: () => {
        ...
        state.loginForm.validate(async valid => {
          if (valid) {
            state.loading = true;
            const { code, data, message } = await Login(state.model).catch(() => {
              state.loading = false;
              console.log('登录失败');
            });
            if (+code === 200) {
...
const _withScopeId = n => (pushScopeId("data-v-749db7dc"),n=n(),popScopeId(),n);
const _hoisted_1 = { class: "login" };
const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createBaseVNode("h1", { class: "title" }, "智能物联控制中台", -1));
...
var index = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render],['__scopeId',"data-v-749db7dc"]]);
