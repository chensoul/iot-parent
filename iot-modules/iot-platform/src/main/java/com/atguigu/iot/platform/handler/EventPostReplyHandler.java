 ...
 */
@Service
@GuiguEmqx(event = GuiguEmqxConstants.TOPIC_EVENT_POST_REPLY)
public class EventPostReplyHandler implements MessageHandler {
    ...
    public void handleMessage(JSONObject message) {
        ...
        if(event.equals("message.publish")){
            //修改设备的事件上报的操作日志,为完成
            deviceEventDataService.updateDeviceEventData(message);
        }
    }
}
